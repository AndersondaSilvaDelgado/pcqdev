...
class FormularioCTR {
    ...
    public function salvarCompleto($body) {
        $idCabecArray = array();
        $cabecArray = json_decode($body);
        foreach($cabecArray as $cabec){
            $this->salvarCabec($cabec);
            $idCabecBD = $this->salvarCabec($cabec);
            $this->salvarItem($idCabecBD, $cabec->respItemBeanList);
            $this->salvarBrigadista($idCabecBD, $cabec->brigadistaItemBeanList);
            $this->salvarEquip($idCabecBD, $cabec->equipItemBeanList);
            $this->salvarFoto($idCabecBD, $cabec->fotoItemBeanList);
            $this->salvarTalhao($idCabecBD, $cabec->talhaoItemBeanList);
